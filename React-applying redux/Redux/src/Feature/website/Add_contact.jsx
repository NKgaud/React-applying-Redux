            ...
            <div className="container mt-5">
                ...
                <h1>{name} {age}</h1>
                    <div className="col-sm-12">
                        ...
                        <Link to="/Mng_contact" className='btn btn-primary float-end mb-5'>
                            Back Home
                        </Link>
                        <br /><br />
                        <form method="post">
                            ...
                            <div className="mb-3">
                                ...
                                <textarea className="form-control" name="msg" value={formvalue.msg} onChange={changehandel} ></textarea>
                            </div>
